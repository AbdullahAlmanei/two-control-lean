...
Mapped from: `reference/rocq/Main.v`
Section title in paper: "4. Four key building blocks"
...
- paper_statement_summary: Suppose u0, u1 are complex numbers with |u0| = |u1| = 1. There exist 2-qubit unitaries U, V and 1-qubit unitaries P0, P1, Q0, Q1 such that |0⟩⟨0| ⊗ U(P0 ⊗ Q0)V + |1⟩⟨1| ⊗ U(P1 ⊗ Q1)V = CC(Diag(u0, u1)) iff either u0 = u1 or u0 u1 = 1.
...
- paper_statement_summary: Suppose u0, u1 are complex numbers with |u0| = |u1| = 1. Suppose Q is a 1-qubit unitary and let |β⟩ = Q|0⟩ and |β⊥⟩ = Q|1⟩. There exist 1-qubit unitaries P0, P1 such that I ⊗ I ⊗ |β⟩⟨β| + P0 ⊗ P1 ⊗ |β⊥⟩⟨β⊥| = CC(Diag(u0, u1)) iff u0 = 1 = u1.
...
- paper_statement_summary: Suppose u0, u1 are complex numbers with |u0| = |u1| = 1. There exist 2-qubit unitaries V1, V2, V3, V4 and 1-qubit unitaries P0, P1, where V1 = |0⟩⟨0| ⊗ P0 + |1⟩⟨1| ⊗ P1, such that V1_AC V2_BC V3_AC V4_BC = CC(Diag(u0, u1)) iff either u0 = u1 or u0 u1 = 1.
...
- section: 4
- source_pages: [222]
- paper_statement_summary: Suppose u0, u1 are complex numbers with |u0| = |u1| = 1. There exist 2-qubit unitaries V1, V2, V3, V4 and 1-qubit unitaries P0, P1, where V4 = |0⟩⟨0| ⊗ P0 + |1⟩⟨1| ⊗ P1, such that V1_AC V2_BC V3_AC V4_BC = CC(Diag(u0, u1)) iff either u0 = u1 or u0 u1 = 1.
